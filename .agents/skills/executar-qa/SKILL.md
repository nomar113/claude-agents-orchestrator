...
## Error Handling
- If the application is not running, instruct the user to start it before retrying.
- If Playwright MCP is unavailable, report the error and suggest running E2E tests manually.
